<template>
  <div class="bg-gradient-to-r from-gray-100 via-red-300 to-gray-500 w-full min-h-screen flex justify-center items-start">
    <div class="bg-white shadow-xl rounded-lg p-8 w-full max-w-4xl mt-24 mx-8 transform transition-transform duration-300 ease-in-out hover:scale-105">
      ...
      <div class="flex flex-col justify-center items-center">
        <div class="w-16 h-16 bg-gray-700 rounded-full flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-gray-500">
        ...
        <div class="mt-12 w-full">
          <Form :validation-schema="schema" @submit="saveTagChanges" v-slot="{ errors }">
            <div class="pl-8">
